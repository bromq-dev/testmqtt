...
The key words "MUST", "MUST NOT", "REQUIRED", "SHALL", "SHALL NOT", "SHOULD", "SHOULD NOT", "RECOMMENDED", "MAY", and "OPTIONAL" in this specification are to be interpreted as described in IETF RFC 2119 [\[RFC2119\]](#anchor-RFC2119).
...
| byte 7         | Level (4)                                                                                                                                                   | 0     | 0     | 0     | 0     | 0     | 1     | 0     | 0     |
| Connect Flags  |                                                                                                                                                             |       |       |       |       |       |       |       |       |
| byte 8         | User Name Flag (1)<br><br>Password Flag (1)<br><br>Will Retain (0)<br><br>Will QoS (01)<br><br>Will Flag (1)<br><br>Clean Session (1)<br><br>_Reserved_ (0) | 1     | 1     | 0     | 0     | 1     | 1     | 1     | 0     |
| Keep Alive     |                                                                                                                                                             |       |       |       |       |       |       |       |       |
...
- Topic Names and Topic Filters MUST NOT include the null character (Unicode U+0000) \[[Unicode](#Unicode)\] \[MQTT-4.7.3-2\]
